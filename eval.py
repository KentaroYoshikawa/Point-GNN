...
parser.add_argument('--dataset_root_dir', type=str, default='/home/ubuntu/data/git/Point-GNN/dataset/kitti/',
                   help='Path to KITTI dataset. Default="/home/ubuntu/data/git/Point-GNN/dataset/kitti/"')
